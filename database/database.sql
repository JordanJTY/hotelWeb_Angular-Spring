...
--
-- Host: localhost    Database: db_akohotel
-- ------------------------------------------------------
...
CREATE TABLE `reservation` (
  ...
  KEY `FKqxsnjd8o88pg0dbj2cmdvd29p` (`app_user_id`),
  CONSTRAINT `FKdqvqcs183xelcc3daknjftlic` FOREIGN KEY (`apartment_id`) REFERENCES `apartment` (`id`),
  CONSTRAINT `FKqxsnjd8o88pg0dbj2cmdvd29p` FOREIGN KEY (`app_user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-12-15 16:44:10
